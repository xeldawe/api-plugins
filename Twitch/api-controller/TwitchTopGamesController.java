...
import com.xel.proxy.service.TwitchTopGamesService;
 ...
 *
 */
public class TwitchTopGamesController implements Controller{
	
	private TwitchTopGamesService tg = new TwitchTopGamesService();
	...
	@Override
	public List get() {
		System.out.println("TRY TO EXE1");
		return tg.getTopGames(this.service);
	}

	@Override
	public List get(Map map) {
		return tg.getTopGames(map, this.service);
	}
